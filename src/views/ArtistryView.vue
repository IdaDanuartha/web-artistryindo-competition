  ...
  <main class="container artistry">
    ...
    <section class="gallery gap-section" id="gallery">
        ...
        <div class="gap-row row-gallery">
            <a href="../assets/images/gallery-arts/gallery-art-1.svg" data-lightbox="gallery-documentation" class="w-100">
                <img src="../assets/images/gallery-arts/gallery-art-1.svg" alt="Image Gallery" class="img-fluid w-100 image-gallery">
            </a>
            <a href="../assets/images/gallery-arts/gallery-art-2.svg" data-lightbox="gallery-documentation" class="w-100">
                <img src="../assets/images/gallery-arts/gallery-art-2.svg" alt="Image Gallery" class="img-fluid w-100 image-gallery">
            </a>
            <a href="../assets/images/gallery-arts/gallery-art-3.svg" data-lightbox="gallery-documentation" class="w-100">
                <img src="../assets/images/gallery-arts/gallery-art-3.svg" alt="Image Gallery" class="img-fluid w-100 image-gallery">
            </a>
            <a href="../assets/images/gallery-arts/gallery-art-4.svg" data-lightbox="gallery-documentation" class="w-100">
                <img src="../assets/images/gallery-arts/gallery-art-4.svg" alt="Image Gallery" class="img-fluid w-100 image-gallery">
            </a>
            <a href="../assets/images/gallery-arts/gallery-art-5.svg" data-lightbox="gallery-documentation" class="w-100">
                <img src="../assets/images/gallery-arts/gallery-art-5.svg" alt="Image Gallery" class="img-fluid w-100 image-gallery">
            </a>
            <a href="../assets/images/gallery-arts/gallery-art-6.svg" data-lightbox="gallery-documentation" class="w-100">
                <img src="../assets/images/gallery-arts/gallery-art-6.svg" alt="Image Gallery" class="img-fluid w-100 image-gallery">
            </a>
        </div>
    </section>
